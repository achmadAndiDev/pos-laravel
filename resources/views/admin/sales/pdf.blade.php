...
<body>
            ...
            <tr>
                ...
                <td>
                    ...
                    @if($sale->outlet->address)
                        <br><span style="font-size: 7px;">{{ Str::limit($sale->outlet->address, 25) }}</span>
                    @endif
                </td>
                <td>
                    @if($sale->customer)
                        ...
                        @if($sale->customer->phone)
                            <br><span style="font-size: 7px;">{{ $sale->customer->phone }}</span>
                        @endif
                    @else
                        <span style="font-size: 7px;">Walk-in Customer</span>
                    @endif
                </td>
                ...
                <td>
                    ...
                    @if($sale->saleItems->count() > 4)
                        <div style="font-size: 6px; color: #666;">+{{ $sale->saleItems->count() - 4 }} lainnya</div>
                    @endif
                </td>
            </tr>
            @empty
    ...
    <div class="footer">
        ...
        <p>Halaman {{ $sales->count() > 0 ? '1' : '0' }} dari 1</p>
    </div>
</body>
</html>