...
@section('title', 'User')
@section('subtitle', 'Kelola Data User')
...
<style>
    ...
    .role-badge { font-size: 0.75rem; padding: 0.25rem 0.5rem; }
    .outlet-tags { display: flex; flex-wrap: wrap; gap: 0.25rem; }
    .outlet-tag { font-size: 0.7rem; padding: 0.125rem 0.375rem; border-radius: 0.25rem; background-color: var(--tblr-blue-lt); color: var(--tblr-blue); border: 1px solid var(--tblr-blue-lt); }
</style>
@endsection
