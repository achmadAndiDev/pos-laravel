        ...
        <div class="card-body">
          <div class="mb-3">
            ...
            <select name="role" id="role" class="form-select @error('role') is-invalid @enderror" required>
              ...
              <option value="{{ $role->value }}" {{ old('role') === $role->value ? 'selected' : '' }} data-multiple="{{ $role->canAccessMultipleOutlets() ? 'true' : 'false' }}">
                {{ $role->label() }}
              </option>
              @endforeach
            </select>
            ...
            <div id="outlet-selection">
              ...
              <div class="outlet-checkbox">
                <div class="form-check">
                  <input class="form-check-input outlet-checkbox-input" type="checkbox" name="outlets[]" value="{{ $outlet->id }}" id="outlet_{{ $outlet->id }}" {{ in_array($outlet->id, old('outlets', [])) ? 'checked' : '' }}>
